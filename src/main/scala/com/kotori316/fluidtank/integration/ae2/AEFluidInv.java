...
record AEFluidInv(TileTank tank) implements MEStorage {
    ...
    public void getAvailableStacks(KeyCounter out) {
        ...
        amount.ifPresent(fluidAmount -> out.add(AEFluidKey.of(fluidAmount.c(), OptionConverters.toJava(fluidAmount.nbt()).orElse(null)),
            Math.min(fluidAmount.amount(), Long.MAX_VALUE - Integer.MAX_VALUE * 2L)));
    }

    @NotNull
    static GenericAmount<Fluid> fromAEStack(@Nullable AEKey what, long amount) {
