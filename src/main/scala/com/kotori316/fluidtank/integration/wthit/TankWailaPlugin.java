...
public class TankWailaPlugin implements IWailaPlugin {
    ...
    static final ResourceLocation KEY_TANK_INFO = new ResourceLocation(ModTank.modID, WAILA_TANK_INFO);
    static final ResourceLocation KEY_SHORT_INFO = new ResourceLocation(ModTank.modID, WAILA_SHORT_INFO);
